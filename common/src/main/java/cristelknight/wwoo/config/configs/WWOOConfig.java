...
public record WWOOConfig(String mode, boolean onlyVanillaBiomes, boolean forceLargeBiomes, boolean showUpdates, boolean showBigUpdates, BlockState backGroundBlock)
        implements CommentedConfig<WWOOConfig> {

    private static WWOOConfig INSTANCE = null;

    public static final WWOOConfig DEFAULT = new WWOOConfig("DEFAULT", false, false,true, true, Blocks.CALCITE.defaultBlockState());
